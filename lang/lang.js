...
window.onload = function () {
    const translations = {
        'ar': {
            ...
            'head_news': 'أخبار الشركة',
            'head_title_1': 'شركة اعماق الدولية تبرز تقنياتها الحديثة والبيئية في قمة ليبيا للطاقة والاقتصاد',
        ...
        'en': {
            ...
            // start land page news
            'head_news': 'Company News',
            'head_title_1': 'Amaq Al-Dauleya Company Highlights its Modern and Environmental Technologies at Libya Energy and Economy Summit.',
    ...
    function checkForTransElement() {
        ...
        if (icon) {
            ...
            setTimeout(checkForTransElement, 1000); // إعادة المحاولة كل ثانية
        }
    }
